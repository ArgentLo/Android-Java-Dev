...
/** Basic Logic:
 *      -> ArrayList to store our customized object "AndroidFlavor (img, txt, txt)"
 *      -> AndroidFlavorAdapter to store the ArrayList
 *         (AndroidFlavorAdapter is extended from ArrayAdapter to get_img, get_text given position)
 *      -> ListView interacts with Adapter "listView.setAdapter(flavorAdapter)"
 * */
